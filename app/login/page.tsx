    ...
    return <section className=" h-full w-full">
        <div className="w-5/12 mx-auto h-auto p-5 flex justify-between shadow-md bg-white rounded-md shadow-gray-300">
            <div className="w-full">
                ...
                <form className="w-full bg-white z-50 mt-3">
                    <Textbox value={identifier as string} name={'identifier'} onChange={onChange} label="Username, email or Phone"/>
                    <Textbox value={password as string} name={'password'} onChange={onChange} label="Your password" type="password"/>
                    <small>Forgot password ? <Link href="/reset-password" className="text-indigo-600 underline">Reset your password</Link>.</small>
